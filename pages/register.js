...
export default function Register(props) {
    ...
    return (
        <>
            ...
            <Card bg="light">
                <Card.Body><h2>Register</h2>Register your account here: </Card.Body>
            </Card>
            <br />
            <Form onSubmit={handleSubmit}>
                ...
                <br />
                <Form.Group>
                    <Form.Label>Confirm Password:</Form.Label><Form.Control type="password" value={password2} id="password2" name="confirm password" onChange={e => setPassword2(e.target.value)} />
                </Form.Group>
                <br />
